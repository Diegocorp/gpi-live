...
const RegisterForm = (props) => {
  ...
  const handleSubmitClick = async (e) => {
    ...
    if (state.securityCode === "55468955") {
      try {
        const payload = {
      ...
      store.addNotification({
        title: "Codigo de seguridad incorrecto",
        message: "Introdusca el codigo de seguridad correcto para continuar",
        type: "danger",
        insert: "top",
        container: "top-right",
        animationIn: ["animate__animated", "animate__fadeIn"],
  ...
  return (
    <div className="col-lg-7">
      <div className="p-4">
        ...
        <form className={`needs-validation`} onSubmit={handleSubmitClick}>
