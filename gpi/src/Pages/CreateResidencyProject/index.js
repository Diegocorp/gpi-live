...
const CreateResidencyProject = ({ title, edit }) => {
  let { id } = useParams();
  ...
  const [dataObject, setDataObject] = useState({
    ...
    startDate: "",
    conclusionDate: "",
    typeProyect: "Proyecto de residencias",
  ...
  return (
    <div className={`container-fluid  ${isMobile ? "" : "text-left"}`}>
      <div className="d-sm-flex justify-content-between align-items-center mb-4">
        <h2>
          <strong>
            {title ? title : "Gestión de Proyecto de Residencias"}
          </strong>
        </h2>
      </div>
      <div className="row" />
      <form id="projectID" className={`needs-validation`} onSubmit={onSubmit}>
        <div className="col-xl-12 offset-xl-0">
          <div className="card shadow mb-3">
            <div className="card-header py-3">
              <p className="text-primary m-0 font-weight-bold">
                Datos del proyecto de residencias
              </p>
            </div>
                  ...
                  <div className="form-group">
                    ...
                    >
                      <optgroup label="Tipo de proyecto">
                        <option value="Proyecto de residencias">
                ...
                <div className="col">
                  <div className="form-group">
                    <label htmlFor="firstNameContact">
                      <strong>Nombre(s) del asesor de la empresa</strong>
                    </label>
                    <input
                ...
                <div className="col">
                  <div className="form-group">
                    <label htmlFor="lastNameContact">
                      <strong>Apellido(s) del asesor de la empresa</strong>
                    </label>
                    <input
          ...
          <div className="card shadow">
            <div className="card-header py-3">
              <p className="text-primary m-0 font-weight-bold">
                Datos de los alumnos residentes
              </p>
            </div>
            <div className="card-body">
          ...
          <div className="card shadow">
            <div className="card-header py-3">
              <p className="text-primary m-0 font-weight-bold">
                Datos de los Asesores internos del ITSPP
              </p>
            </div>
            <div className="card-body">
...
export default CreateResidencyProject;
